...
public class Rec3Fragment extends BaseComponentFragment<RecommendPresenter> implements RecommendView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = mLayoutInflater.inflate(R.layout.fragment_main_rec3, container, false);
        initView();
        return mRootView;
    }
    ...
    private void initContentData(RecommendedHomeBean mRecommendedHomeBean) {
        ...
        try {
            synchronized (Rec3Fragment.class) {
