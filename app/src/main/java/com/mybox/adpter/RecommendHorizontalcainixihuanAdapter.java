...
public class RecommendHorizontalcainixihuanAdapter extends MyBaseAdapter {
    ...
    public RecommendHorizontalcainixihuanAdapter(Context context, List items) {
        this.items = items;
    ...
    public RecommendHorizontalcainixihuanAdapter(Context context, List items, String Type) {
        this.items = items;
        this.context = context;
        this.Type = Type;
        fb = FinalBitmap.create(context);
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.home_listview_item_gridview_item_cainixihuan, null);
