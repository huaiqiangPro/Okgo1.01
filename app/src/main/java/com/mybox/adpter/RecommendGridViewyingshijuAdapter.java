 ...
 */
public class RecommendGridViewyingshijuAdapter extends MyBaseAdapter {
    ...
    public RecommendGridViewyingshijuAdapter(Context context, List items) {
        this.items = items;
    ...
    public RecommendGridViewyingshijuAdapter(Context context, List items, ViewGroup.LayoutParams params) {
        this.items = items;
        this.context = context;
        this.params = params;
        fb = FinalBitmap.create(context);
    ...
    public RecommendGridViewyingshijuAdapter(Context context, List items, String Type) {
        this.items = items;
        this.context = context;
        this.Type = Type;
        fb = FinalBitmap.create(context);
    ...
    public View getView(final int arg0, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.home_listview_item_gridview_item_yingshiju, null);
...
//                        FitScreenUtil.setParams(gridItemHolder.imageView, 31);
                    ...
                    FitScreenUtil.setParams(gridItemHolder.mImageViewContent, 1, params);
                    FitScreenUtil.setParams(gridItemHolder.imageView, 1, params);
