 ...
 * 注释：首页（推荐页）横向滑动的适配器
 ********************/
public class RecommendHorizontaljinrikandainAdapter extends MyBaseAdapter {
    ...
    public RecommendHorizontaljinrikandainAdapter(Context context, List items) {
        this.items = items;
    ...
    public RecommendHorizontaljinrikandainAdapter(Context context, List items, String Type) {
        this.items = items;
        this.context = context;
        this.Type = Type;
        fb = FinalBitmap.create(context);
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.home_listview_item_gridview_item_jinrikandian, null);
        ...
        // TODO 图间距添加
        if (pos > 0) {
            convertView.setPadding(SizeUtils.dip2px(context,6), 0, 0, 0);
        }
